...
export default function Home() {
	...
	return (
		<main className="h-screen w-screen bg-black">
			<div className="flex flex-col gap-6 items-center pt-32 duration-700 animate-in animate fade-in-5 slide-in-from-bottom-2.5">
				<h1 className="text-5xl tracking-tight font-bold text-white">SpeedSearchAPI</h1>
